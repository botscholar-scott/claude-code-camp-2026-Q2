...
A very common way to drive specific functionality is through agent skills which are packaged scripts and instructions adopted by many coding harnesses and agent SDKs.

We should create a skill that has its own script to help it connect to our MUD, we should attempt to have it manage its own data.
